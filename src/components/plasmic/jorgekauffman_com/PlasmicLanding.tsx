...
function PlasmicLanding__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        {
          "The best ideas emerge from combining insights from fields that don’t seem connected.\nI make those connections and collaborate with SMEs on projects to push forward innovative work."
        }
      </div>
      ...
      >
        {
          "I create value for your organisation by delivering digital transformation."
        }
      </div>
    </div>
